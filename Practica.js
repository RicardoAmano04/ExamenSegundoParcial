...
function campo_v1(){
document.f_rfc.nom.style.background="#FFA07A";
}
function campo_v2(){
document.f_rfc.ap.style.background="#FFA07A";
}
function campo_v3(){
document.f_rfc.am.style.background="#FFA07A";
}
function campo_v4(){
document.f_rfc.fec.style.background="#FFA07A";
}
